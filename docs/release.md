...
prereleases; final tags such as `v0.1.35` are published as stable GitHub releases.
...
```sh
gh workflow run release-assets.yml -f tag=v0.1.35
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/mojindri/Blackwire/v0.1.35/scripts/install.sh \
  | VERSION=v0.1.35 bash
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/mojindri/Blackwire/v0.1.35/scripts/install.sh \
  | VERSION=v0.1.35 CONFIG_PATH=/path/to/config.json bash
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/mojindri/Blackwire/v0.1.35/scripts/install.sh \
  | VERSION=v0.1.35 SETUP=reality PUBLIC_HOST=example.com bash
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/mojindri/Blackwire/v0.1.35/scripts/install.sh \
  | VERSION=v0.1.35 SETUP=domain DOMAIN=proxy.example.com PROXY_PATH=/secret-path INSTALL_NGINX=1 INSTALL_CERTBOT=1 START_SERVICE=1 bash
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/mojindri/Blackwire/v0.1.35/scripts/install.sh \
  | VERSION=v0.1.35 INSTALL_BLACK_UI=1 bash
```
