...
```sh
curl -fsSLO https://raw.githubusercontent.com/mojindri/Blackwire/v0.2.1/scripts/install.sh
chmod +x install.sh
VERSION=v0.2.1 RUNTIME_DATABASE_URL_FILE=/secure/runtime-database-url ./install.sh
```
...
RUN_DB_MIGRATIONS=1 INSTALL_BLACK_UI=1 VERSION=v0.2.1 ./install.sh
```
