...
- Docker REALITY and Vision scenarios use the internal TLS cover's stable lab
  address (`10.203.0.10:443`) with SNI `blackwire.local`; VPS renders retain
  the cover configured in the private matrix environment.
